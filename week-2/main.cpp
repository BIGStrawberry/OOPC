...
TEST_CASE("Vector: Operator, multiply right hand integer") {
    Vector v(3, 5);
    int i = 2;
    REQUIRE((v * i) == Vector(6, 10));
}

TEST_CASE("Vector: Operator, multiply left hand integer") {
    Vector v(3, 5);
    int i = 2;
...
TEST_CASE("Vector: Operator, multiply assignment (integer)") {
    Vector v(3, 5);
    int i = 2;
    v *= i;
    REQUIRE(v == Vector(6, 10));
